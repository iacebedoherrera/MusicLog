...
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Sistema             | `GET /health`                                                                                                                       | Requiere JWT. Responde exactamente `{"status":"UP"}` cuando la aplicación está disponible; no expone identidad, secretos, configuración interna ni infraestructura. |
